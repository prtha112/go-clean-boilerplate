...
func NewPostgresOrderRepository(db *sql.DB) domain.Repository {
	return &PostgresOrderRepository{db: db}
}

func (r *PostgresOrderRepository) DeleteByID(id int) error {
...
func (r *PostgresOrderRepository) GetByID(id int) (*domain.Order, error) {
